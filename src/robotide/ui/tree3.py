...
class DnD(with_metaclass(treemixin.DragAndDrop)):
    pass

class DCT(DnD, with_metaclass(customtreectrl.CustomTreeCtrl)):
    pass

class RE(DCT, with_metaclass(utils.RideEventHandler)):
    pass
