...
# futurized class KeywordEditor(with_metaclass(classmaker(), type('NewBase', (GridEditor, RideEventHandler), {}))):

from sys import version_info
if version_info[0] < 3:
    from robotide.utils.noconflict import classmaker

    class KeywordEditor(GridEditor, utils.RideEventHandler):
...
work.</li>
    ...
    from .kweditor3 import KeywordEditor
    KeywordEditor.__base__.__init__()
